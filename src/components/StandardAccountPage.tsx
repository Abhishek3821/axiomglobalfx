...
export const StandardAccountPage = () => {
  return (
    // Clean, deep slate background. Textured gold used strictly for premium accents.
    <div className="bg-slate-950 text-white min-h-screen overflow-hidden font-sans pt-20 selection:bg-[#D4AF37] selection:text-black">
      ...
      <section className="relative min-h-[90vh] flex flex-col items-center justify-center overflow-hidden z-10 border-b border-[#D4AF37]/10">
        ...
        <div className="absolute inset-0 z-10 pointer-events-none hidden md:block">
          <div className="max-w-7xl mx-auto w-full h-full relative">
            <PlatformCard3D top="20%" left="15%" rotate={-15} scale={0.8} delay={0} label="MT4" color="text-white" />
            <PlatformCard3D bottom="25%" right="15%" rotate={15} scale={0.9} delay={1.2} label="MT5" color="text-white" />
          </div>
        </div>
        ...
        <div className="relative z-20 text-center px-4 max-w-4xl mx-auto mt-12">
          ...
          >
            ...
            <span className="text-[10px] font-bold uppercase tracking-widest">Most Popular Account</span>
          </motion.div>
          ...
          >
            The perfect balance of features and flexibility. Trade with tight spreads, no commissions, and access to all our trading instruments.
          </motion.p>
          ...
          >
            <StatCard label="Min Deposit" value="$100" highlight />
            <StatCard label="Leverage" value="Up to 1:500" />
            <StatCard label="Spreads" value="From 1.0 Pips" />
            <StatCard label="Commission" value="Zero" />
          </motion.div>
        </div>
      </section>
      ...
      >
        <div className="max-w-7xl mx-auto px-4">
          <motion.div variants={fadeUpVariant} className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">Why Choose Standard?</h2>
            <p className="text-slate-400 max-w-2xl mx-auto">Designed for traders who want a straightforward trading experience with highly competitive conditions.</p>
          </motion.div>
          <div className="grid md:grid-cols-3 gap-8">
            <FeatureCard icon={<Zap />} title="Zero Commission" desc="Trade all instruments with no commission fees. All costs are included directly in the spread." />
            <FeatureCard icon={<Star />} title="Tight Spreads" desc="Enjoy highly competitive spreads starting from as low as 1.0 pips on major currency pairs." />
            <FeatureCard icon={<BarChart3 />} title="Full Market Access" desc="Trade Forex, Indices, Commodities, and Cryptocurrencies all from a single account." />
          </div>
        </div>
      </motion.section>
      ...
      <motion.section 
        ...
        className="py-24 bg-slate-950 border-y border-[#D4AF37]/5"
      >
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="bg-slate-900/50 border border-white/5 rounded-3xl p-8 md:p-12 shadow-2xl backdrop-blur-sm relative overflow-hidden">
            ...
            <div className="grid md:grid-cols-2 gap-x-16 gap-y-6 relative z-10">
              <SpecItem label="Minimum Deposit" value="$100" />
              <SpecItem label="Contract Size" value="1 Lot = 100,000 units" />
              <SpecItem label="Leverage" value="Up to 1:500" />
      ...
      >
        <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center gap-16">
          <div className="flex-1">
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-white">Trade on Industry-Leading Platforms</h2>
            <p className="text-slate-400 mb-8 leading-relaxed">
              Your Standard account is fully compatible with the world's most popular trading platforms. Experience seamless trading execution on desktop, web, and mobile devices.
            </p>
            <div className="space-y-4">
              <div className="flex items-center gap-4 p-4 rounded-xl bg-slate-950 border border-white/5 hover:border-[#D4AF37]/30 transition-colors group">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center items-center gap-12 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
            {/* Kept text placeholders as requested in previous iterations */}
      ...
      <motion.section 
        initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUpVariant}
        className="py-24 bg-slate-950 border-t border-[#D4AF37]/5"
      >
        <div className="max-w-3xl mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold mb-12 text-center text-white">Frequently Asked Questions</h2>
          <div className="space-y-4">
            <FaqItem question="Is there a commission on the Standard account?" answer="No, there are strictly zero commissions on the Standard account. All trading costs are built directly into the spread." />
            <FaqItem question="What is the minimum deposit?" answer="The minimum deposit required to open and activate a Standard account is just $100." />
            <FaqItem question="Can I use EAs (Expert Advisors) on this account?" answer="Yes, absolutely. All our accounts fully support Expert Advisors (EAs), algorithmic trading, and scalping strategies." />
          </div>
        </div>
      </motion.section>

      {/* 8. FINAL CTA SECTION */}
      <section className="py-24 relative overflow-hidden border-t border-[#D4AF37]/20 bg-slate-950">
        ...
        <div className="max-w-4xl mx-auto px-4 relative z-10 text-center flex flex-col items-center">
          ...
          <p className="text-slate-400 text-base md:text-lg mb-10 max-w-2xl mx-auto font-light">
            Join thousands of global traders on our most popular, flexible, and feature-rich account type.
          </p>
...
const PlatformCard3D = ({ top, bottom, left, right, rotate, scale, delay, label, color }: any) => {
  return (
    <motion.div
      className="absolute"
    ...
    >
      <div 
        ...
        style={{ 
          ...
          width: '120px',
          height: '120px',
          // Subtle inner gold glow for texture
          boxShadow: '0 20px 40px rgba(0,0,0,0.5), inset 0 0 0 1px rgba(212,175,55,0.2)' 
        }}
      >
        <span className={`text-4xl font-black ${color} drop-shadow-lg`}>{label}</span>
      </div>
    </motion.div>
  );
};
...
const FeatureCard = ({ icon, title, desc }: { icon: React.ReactNode; title: string; desc: string }) => (
  <div className="p-8 rounded-2xl bg-slate-900/40 border border-[#D4AF37]/10 hover:border-[#D4AF37]/50 hover:bg-slate-900/80 transition-all text-center group shadow-lg backdrop-blur-sm">
...
const SecurityCard = ({ icon, title, desc }: { icon: React.ReactNode; title: string; desc: string }) => (
  <div className="p-8 rounded-2xl bg-slate-900/40 border border-[#D4AF37]/10 hover:border-[#D4AF37]/50 hover:shadow-[0_0_30px_rgba(212,175,55,0.15)] transition-all group text-center backdrop-blur-sm">
    <div className="w-16 h-16 rounded-full bg-gradient-to-br from-[#D4AF37]/20 to-[#AA7C11]/10 border border-[#D4AF37]/20 flex items-center justify-center text-[#FDE08B] mb-6 mx-auto group-hover:scale-110 transition-transform shadow-[inset_0_0_15px_rgba(212,175,55,0.1)]">
...
const FaqItem = ({ question, answer }: { question: string; answer: string }) => (
  <div className="p-6 rounded-2xl bg-slate-900/40 border border-[#D4AF37]/10 backdrop-blur-sm hover:bg-slate-900 hover:border-[#D4AF37]/30 transition-colors cursor-pointer group shadow-lg">
